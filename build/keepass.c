/*
    keepass, Ruby binding to libkpass
    Copyright (C) 2009 Rob Hoelz - no license supplied with original libkpass
    wrapper https://github.com/hoelzro/ruby-keepass
    libkpass-6 support by bumuckl https://github.com/bumuckl/ruby-keepass
*/
